...
**Team Internet (Acquired Wando)** | Munich/Berlin

*Senior Backend Engineer & Architect* | **Oct 2018 – PRESENT**
...
* **E-commerce Optimization:** Developed a custom A/B testing framework, utilizing statistical models to drive conversion improvements.  
* **Feature Engineering:** Implemented complex time-booking systems and integrated multiple 3rd-party payment and logistics APIs.
...
*Master of Physics (Radiophysics and Quantum Electronics)* | **2008 – 2014**

* Major in Electronics and Information Technologies.  
* Developed a strong foundation in statistical analysis and causal inference, applied to experimental design and system optimization.

---

### **CERTIFICATIONS & LANGUAGES**

* **Certification:** New Relic Certified Performance Pro  
* **English:** Professional working proficiency  
* **German:** Communicational  
